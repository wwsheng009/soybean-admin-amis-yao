...
import AmisAxiosInstance from './amis_instance';
...
export function createAmisRequest(axiosConfig: AxiosRequestConfig, backendConfig?: Service.BackendResultConfig) {
  const customInstance = new AmisAxiosInstance(axiosConfig, backendConfig);
